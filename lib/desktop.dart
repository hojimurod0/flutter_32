  ...
  Widget build(BuildContext context) {
    ...
    Widget cars(String name, String link, String price, String category) {
      return Container(
        ...
        height: screenW * 0.3,
        decoration: BoxDecoration(
            color: Color.fromARGB(255, 178, 206, 66),
              ...
              children: [
                ...
                IconButton(
                    ...
                    icon: Icon(
                      ...
                      color: const Color.fromARGB(255, 225, 28, 28),
                      size: screenW * 0.015,
                    ))
              ],
            ),
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color: const Color.fromARGB(255, 238, 35, 35),
                          size: screenW * 0.015,
                        ),
                        Text(
                          '90L',
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color.fromARGB(255, 186, 107, 119),
                  ),
                  child: Text(
                    'Rent Now',
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      image: DecorationImage(
                        image: NetworkImage("asset/images/prfil.png"),
                      ),
                    ),
                  )
                ],
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          child: Expanded(
                              child: Image(
                                  image: AssetImage('asset/images/car1.png'))),
                        ),
                        Container(
                          width: screenW * 0.46,
                          child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Morent has a low price and also a large variety of cars with good and comfortable facilities. In addition, the service provided by the officers is also very friendly and very polite.',
